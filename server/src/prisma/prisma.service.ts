...
export class PrismaService implements OnModuleInit, OnModuleDestroy {
  ...
  get workPattern() { return this._client.workPattern }
  get attendance() { return this._client.attendance }
  get breakRecord() { return this._client.breakRecord }
  get clockCorrection() { return this._client.clockCorrection }
  get leaveRequest() { return this._client.leaveRequest }
  get closingRecord() { return this._client.closingRecord }
